...
class Assignment{
    ...
    {    
        ...
        // While Array Contains Username, Reprompt
    ...
    characterList()
    {
        // If localStorage is null, Return to Menu
        ...
        {
            // Sort Array & Clear Screen
            players.sort();
            console.clear();
            menu.NewTitle("Display Character");
            players.push
            // Display each Player in Object Array
            players.forEach(element => {
...
class DOMStuff{
    ...
    viewCharacter(event){
        event.preventDefault();
        // Split localStorage into String Array
